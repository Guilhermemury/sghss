 ...
 * Responsável pela segurança da autenticação stateless.
 */
@Component
public class JwtUtil {
    ...
    /**
     * Cria um token JWT com as claims e o subject fornecidos.
     */
    ...
    /**
     * Valida o token JWT verificando o usuário e a expiração.
     */
